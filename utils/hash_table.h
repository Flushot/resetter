 ...
 */
hash_table_entry *ht_init_entry(void *key, size_t key_size, void *value, size_t value_size);
 ...
 *
 */
typedef void (*ht_iter_func)(hash_table_entry *entry, int index, void *user_arg);
